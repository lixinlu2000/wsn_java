...
print(gcf,'-depsc','nodeNum_consumedEnergy_bar_HorizontalLegend.eps');
print(gcf,'-djpeg','nodeNum_consumedEnergy_bar_HorizontalLegend.jpeg');
print(gcf,'-dtiff','nodeNum_consumedEnergy_bar_HorizontalLegend.tif');
print(gcf,'-dbitmap','nodeNum_consumedEnergy_bar_HorizontalLegend.bmp');
print(gcf,'-dpng','nodeNum_consumedEnergy_bar_HorizontalLegend.png');

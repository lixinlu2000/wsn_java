...
print(gcf,'-depsc','answerMessageSize_consumedEnergy_bar.eps');
print(gcf,'-djpeg','answerMessageSize_consumedEnergy_bar.jpeg');
print(gcf,'-dtiff','answerMessageSize_consumedEnergy_bar.tif');
print(gcf,'-dbitmap','answerMessageSize_consumedEnergy_bar.bmp');
print(gcf,'-dpng','answerMessageSize_consumedEnergy_bar.png');

...
print(gcf,'-depsc','queryMessageSize_packetFrameNum_bar.eps');
print(gcf,'-djpeg','queryMessageSize_packetFrameNum_bar.jpeg');
print(gcf,'-dtiff','queryMessageSize_packetFrameNum_bar.tif');
print(gcf,'-dbitmap','queryMessageSize_packetFrameNum_bar.bmp');
print(gcf,'-dpng','queryMessageSize_packetFrameNum_bar.png');

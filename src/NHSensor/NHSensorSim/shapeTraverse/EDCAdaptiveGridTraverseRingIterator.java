...
public class EDCAdaptiveGridTraverseRingIterator extends TraverseRingIterator
		implements TraverseRingRepairIterator {
	RingSector firstRingSector;
	final static double MIN_DOUBLE_VALUE = 0.0000001;

	public EDCAdaptiveGridTraverseRingIterator(Algorithm alg,
	...
	protected double caculateMaxSita() {
		...
		return EDCAdaptiveGridTraverseRingIterator.calculateRingSectorSita(

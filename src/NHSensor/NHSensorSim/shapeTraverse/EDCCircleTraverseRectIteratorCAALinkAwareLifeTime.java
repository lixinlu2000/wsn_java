 ...
 */
public class EDCCircleTraverseRectIteratorCAALinkAwareLifeTime extends
	...
	private EDCCircleTraverseRectIteratorCAAUseEndBoundLinkAwareLifeTime ectrDD;
	double rectSizeScale = 10;

	public EDCCircleTraverseRectIteratorCAALinkAwareLifeTime(Algorithm alg,
			int direction, Rect rect) {
		super(alg, direction, rect);
		ectrDD = new EDCCircleTraverseRectIteratorCAAUseEndBoundLinkAwareLifeTime(alg,
				direction, rect);
	}

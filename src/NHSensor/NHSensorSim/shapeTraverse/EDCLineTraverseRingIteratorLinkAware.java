...
public class EDCLineTraverseRingIteratorLinkAware extends TraverseRingIterator {
	...
	public EDCLineTraverseRingIteratorLinkAware(Algorithm alg,
	...
	protected double caculateMaxSita() {
		...
		return EDCLineTraverseRingIteratorLinkAware.calculateRingSectorSita(
			...
			if (nextNa == null) {
				...
				circle = new Circle(
						...
						nextNa.getPos().distance(curNa.getPos())
								+ EDCLineTraverseRingIteratorLinkAware.MINI_DOUBLE_VALUE);

 ...
 */
public class IWQETraverseRectIteratorDonotGetAround extends
		TraverseRectIterator {
	static Logger logger = Logger
			.getLogger(IWQETraverseRectIteratorDonotGetAround.class);

	public IWQETraverseRectIteratorDonotGetAround(Algorithm alg, int direction,
			Rect rect) {

...
public class EDCCircleTraverseRingIterator extends TraverseRingIterator {
	...
	public EDCCircleTraverseRingIterator(Algorithm alg,
	...
	protected double caculateMaxSita() {
		...
		return EDCCircleTraverseRingIterator.calculateRingSectorSita(lowRadius,
		...
		if (curShape instanceof RingSector) {
			...
			if (nextNa == null) {
				...
				circle = new Circle(curNa.getPos(), nextNa.getPos().distance(
						curNa.getPos())
						+ EDCCircleTraverseRingIterator.MINI_DOUBLE_VALUE);

 ...
 */
public class EDCGridTraverseRectIteratorGBARepair extends TraverseRectIterator {

	public EDCGridTraverseRectIteratorGBARepair(Algorithm alg, int direction,
			Rect rect) {
	...
	public int repairNodeNum(NeighborAttachment curNa, Rect curRect) {
		double radioRange = this.alg.getParam().getRADIO_RANGE();
		double x0 = curNa.getNode().getPos().getX();
		double y0 = curNa.getNode().getPos().getY();
		;

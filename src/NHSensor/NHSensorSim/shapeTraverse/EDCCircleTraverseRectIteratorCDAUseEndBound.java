 ...
 */
public class EDCCircleTraverseRectIteratorCDAUseEndBound extends
		TraverseRectByCircleIterator implements TraverseShapeOptimizeIterator {
	private final double MINOR_DOUBLE = 0.00001;

	public EDCCircleTraverseRectIteratorCDAUseEndBound(Algorithm alg,
	...
	protected NextNaAndShape caculateNextNaAndShape(NeighborAttachment curNa,
		...
		if (nas.isEmpty()) {
			...
			Collections.sort(nas, new NodeDirectionDistanceComparator(

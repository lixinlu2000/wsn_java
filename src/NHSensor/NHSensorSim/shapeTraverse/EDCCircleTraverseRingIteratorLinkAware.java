...
public class EDCCircleTraverseRingIteratorLinkAware extends
	...
	public EDCCircleTraverseRingIteratorLinkAware(Algorithm alg,
	...
	protected double caculateMaxSita() {
		...
		return EDCCircleTraverseRingIteratorLinkAware.calculateRingSectorSita(
			...
			if (nextNa == null) {
				...
				circle = new Circle(
						...
						nextNa.getPos().distance(curNa.getPos())
								+ EDCCircleTraverseRingIteratorLinkAware.MINI_DOUBLE_VALUE);

...
public class CollectTreeResultEventForTAGNew extends RadioEvent {
	private TreeEvent treeEvent;
	private Vector ans = new Vector();
	private Rect answersRect;

	public CollectTreeResultEventForTAGNew(TreeEvent treeEvent,
			Rect answersRect, Algorithm alg) {
		super(alg);

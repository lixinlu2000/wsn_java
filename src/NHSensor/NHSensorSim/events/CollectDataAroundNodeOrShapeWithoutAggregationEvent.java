 ...
 * for iwqe
 */
public class CollectDataAroundNodeOrShapeWithoutAggregationEvent extends
		CollectDataInShapeEvent {
	static Logger logger = Logger
			.getLogger(CollectDataAroundNodeOrShapeWithoutAggregationEvent.class);
	protected NeighborAttachment queryNa;
	protected Shape region; // the collected data must in region

	public CollectDataAroundNodeOrShapeWithoutAggregationEvent(
	...
	public String toString() {
		...
		sb.append("CollectDataAroundNodeOrShapeWithoutAggregationEvent ");

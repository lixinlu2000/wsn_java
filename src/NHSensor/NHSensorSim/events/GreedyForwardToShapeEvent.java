...
public class GreedyForwardToShapeEvent extends ForwardToShapeEvent {
	public GreedyForwardToShapeEvent(NeighborAttachment root, Shape shape,
	...
	public void handle() throws SensornetBaseException {
		...
		while (!this.getShape().contains(cur.getNode().getPos())) {
			next = cur.getNextNeighborAttachmentToDestInShape(dest, shape);
			if (cur != next) {
	...
	public String toString() {
		...
		sb.append("GreedyForwardToShapeEvent  ");

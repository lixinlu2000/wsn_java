...
public class CollectDataInRectViaNodeExOldEvent extends CollectDataInShapeEvent {
	static Logger logger = Logger
			.getLogger(CollectDataInRectViaNodeExOldEvent.class);
	...
	public CollectDataInRectViaNodeExOldEvent(NeighborAttachment root,

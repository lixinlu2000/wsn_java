 ...
 */
public class CollectDataInShapeAndSendQueryToANodeEventForIDC extends
		CollectDataInShapeEvent {
	static Logger logger = Logger
			.getLogger(CollectDataInShapeAndSendQueryToANodeEventForIDC.class);
	...
	public CollectDataInShapeAndSendQueryToANodeEventForIDC(
	...
	public String toString() {
		...
		sb.append("CollectDataInShapeAndSendQueryToANodeEventForIDC ");

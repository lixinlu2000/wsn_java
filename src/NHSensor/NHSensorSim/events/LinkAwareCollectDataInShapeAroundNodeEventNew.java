 ...
 */
public class LinkAwareCollectDataInShapeAroundNodeEventNew extends
		CollectDataInShapeEvent {
	static Logger logger = Logger
			.getLogger(LinkAwareCollectDataInShapeAroundNodeEventNew.class);
	protected NeighborAttachment queryNa;

	public LinkAwareCollectDataInShapeAroundNodeEventNew(

...
/*
 * The difference between IdealCollectDataAroundNodeOrShapeEventWeakFailureAware and
 * IdealCollectDataAroundNodeOrShapeEventFailureAware is whether to use
 * failure aware routing!
 */
public class IdealCollectDataAroundNodeOrShapeEventWeakFailureAware extends
		CollectDataInShapeEvent {
	static Logger logger = Logger
			.getLogger(IdealCollectDataAroundNodeOrShapeEventWeakFailureAware.class);
	protected NeighborAttachment queryNa;
	protected Rect rect; // the collected data must in rect

	public IdealCollectDataAroundNodeOrShapeEventWeakFailureAware(

 ...
 * for iwqe
 */
public class IdealCollectDataAroundNodeOrShapeEvent extends
		CollectDataInShapeEvent {
	static Logger logger = Logger
			.getLogger(IdealCollectDataAroundNodeOrShapeEvent.class);
	protected NeighborAttachment queryNa;
	protected Rect rect; // the collected data must in rect

	public IdealCollectDataAroundNodeOrShapeEvent(NeighborAttachment root,

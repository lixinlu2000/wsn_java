...
/*
 * The difference between CollectDataInRectViaNodeExEventFailureAware and
 * CollectDataInRectViaNodeExEventWeakFailureAware is  is whether to use
 * failure aware routing!
 */

public class CollectDataInRectViaNodeExEventFailureAware extends
		CollectDataInShapeEvent {
	static Logger logger = Logger
			.getLogger(CollectDataInRectViaNodeExEventFailureAware.class);
	...
	public CollectDataInRectViaNodeExEventFailureAware(NeighborAttachment root,
	...
	public String toString() {
		...
		sb.append("CollectDataInRectViaNodeExEventFailureAware ");

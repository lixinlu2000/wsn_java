...
public class GreedyForwardToPointEventFailureAware extends ForwardToShapeEvent {
	public GreedyForwardToPointEventFailureAware(NeighborAttachment root,
	...
	public void handle() throws SensornetBaseException {
		...
		NeighborAttachment next = cur
				.getNextNeighborAttachmentToDestFailureAware(dest);
	...
	public String toString() {
		...
		sb.append("GreedyForwardToPointEventFailureAware  ");

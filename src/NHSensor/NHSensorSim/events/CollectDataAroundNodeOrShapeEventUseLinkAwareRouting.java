 ...
 * for iwqe
 */
public class CollectDataAroundNodeOrShapeEventUseLinkAwareRouting extends
		CollectDataInShapeEvent {
	static Logger logger = Logger
			.getLogger(CollectDataAroundNodeOrShapeEventUseLinkAwareRouting.class);
	protected NeighborAttachment queryNa;
	protected Rect rect; // the collected data must in rect

	public CollectDataAroundNodeOrShapeEventUseLinkAwareRouting(
	...
	public String toString() {
		...
		sb.append("CollectDataAroundNodeOrShapeEventUseLinkAwareRouting ");

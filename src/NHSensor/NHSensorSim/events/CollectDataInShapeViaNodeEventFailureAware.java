 ...
 * for shape traverse
 */
public class CollectDataInShapeViaNodeEventFailureAware extends
		CollectDataInShapeEvent {
	static Logger logger = Logger
			.getLogger(CollectDataInShapeViaNodeEventFailureAware.class);
	protected NeighborAttachment queryNa;

	public CollectDataInShapeViaNodeEventFailureAware(NeighborAttachment root,
	...
	public String toString() {
		...
		sb.append("CollectDataInShapeViaNodeEventFailureAware ");

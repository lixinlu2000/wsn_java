...
public class EDCCircleTraverseRectEventCDAFailureAware extends
		TraverseRectEvent {
	static Logger logger = Logger
			.getLogger(EDCCircleTraverseRectEventCDAFailureAware.class);
	protected int direction;
	int backupNodeNum = 0;

	public EDCCircleTraverseRectEventCDAFailureAware(Message message,
			Algorithm alg) {
		super(message, alg);
	}

	public EDCCircleTraverseRectEventCDAFailureAware(NeighborAttachment root,

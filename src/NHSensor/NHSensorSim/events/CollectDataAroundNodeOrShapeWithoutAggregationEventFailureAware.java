 ...
 * for iwqe
 */
public class CollectDataAroundNodeOrShapeWithoutAggregationEventFailureAware
		extends CollectDataInShapeEvent {
	static Logger logger = Logger
			.getLogger(CollectDataAroundNodeOrShapeWithoutAggregationEventFailureAware.class);
	protected NeighborAttachment queryNa;
	protected Shape region; // the collected data must in region

	public CollectDataAroundNodeOrShapeWithoutAggregationEventFailureAware(
	...
	public String toString() {
		...
		sb
				.append("CollectDataAroundNodeOrShapeWithoutAggregationEventFailureAware ");

 ...
 * for grid traverse
 */
public class CollectDataInShapeViaNodeEventForERIST extends
		CollectDataInShapeEvent {
	static Logger logger = Logger
			.getLogger(CollectDataInShapeViaNodeEventForERIST.class);
	protected NeighborAttachment queryNa;

	public CollectDataInShapeViaNodeEventForERIST(NeighborAttachment root,
	...
	public String toString() {
		...
		sb.append("CollectDataInShapeViaNodeEventForERIST ");

...
import NHSensor.NHSensorSim.shapeTraverse.EDCCircleTraverseRectIteratorCDAUseEndBoundLinkAware;

public class LinkAwareEDCGridTraverseRectEventCDAForRESA extends
		TraverseRectEvent {
	static Logger logger = Logger
			.getLogger(LinkAwareEDCGridTraverseRectEventCDAForRESA.class);
	protected int direction;

	public LinkAwareEDCGridTraverseRectEventCDAForRESA(Message message,
			Algorithm alg) {
		super(message, alg);
	}

	public LinkAwareEDCGridTraverseRectEventCDAForRESA(NeighborAttachment root,
	...
	public void handle() throws SensornetBaseException {
		...
		Shape nextShape;
		EDCCircleTraverseRectIteratorCDAUseEndBoundLinkAware rti = new EDCCircleTraverseRectIteratorCDAUseEndBoundLinkAware(
		...
		logger
				.debug("EDCCircleTraverseRectIteratorCDAUseEndBoundLinkAware start");
		do {
		...
		logger
				.debug("EDCCircleTraverseRectIteratorCDAUseEndBoundLinkAware end");
	}

	public String toString() {
		StringBuffer sb = new StringBuffer();
		sb.append("LinkAwareEDCGridTraverseRectEventCDAForRESA ");

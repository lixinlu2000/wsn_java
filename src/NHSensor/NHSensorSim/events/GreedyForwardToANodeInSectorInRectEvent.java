...
public class GreedyForwardToANodeInSectorInRectEvent extends ForwardToShapeEvent {
	protected int direction;
	protected NeighborAttachment firstTryLastNode = null;

	public GreedyForwardToANodeInSectorInRectEvent(NeighborAttachment root,
	...
	public void handle() throws SensornetBaseException {
		...
		GreedyForwardToAnotherNodeInShapeEvent event;
		Message msg = this.getMessage();
		boolean firstTry = true;
		
		while(!destShape.contains(cur.getPos())) {
			event = new GreedyForwardToAnotherNodeInShapeEvent(cur, destShape, msg, this.getAlg());
	...
	public String toString() {
		...
		sb.append("GreedyForwardToANodeInSectorInRectEvent  ");

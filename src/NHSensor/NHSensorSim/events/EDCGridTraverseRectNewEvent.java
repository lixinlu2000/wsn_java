...
public class EDCGridTraverseRectNewEvent extends TraverseRectEvent {
	static Logger logger = Logger.getLogger(EDCGridTraverseRectNewEvent.class);
	protected int direction;

	public EDCGridTraverseRectNewEvent(Message message, Algorithm alg) {
		super(message, alg);
	}

	public EDCGridTraverseRectNewEvent(NeighborAttachment root, Rect rect,
	...
	public void handle() throws SensornetBaseException {
		...
		logger.debug("EDCGridTraverseRectNewEvent start");
		do {
		...
		logger.debug("EDCGridTraverseRectNewEvent end");
	}

	public String toString() {
		StringBuffer sb = new StringBuffer();
		sb.append("EDCGridTraverseRectNewEvent ");

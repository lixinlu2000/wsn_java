 ...
 * for grid traverse
 */
public class CollectDataInShapeViaNodeEvent extends CollectDataInShapeEvent {
	static Logger logger = Logger
			.getLogger(CollectDataInShapeViaNodeEvent.class);
	protected NeighborAttachment queryNa;

	public CollectDataInShapeViaNodeEvent(NeighborAttachment root,
	...
	public String toString() {
		...
		sb.append("CollectDataInShapeViaNodeEvent ");

...
import NHSensor.NHSensorSim.shapeTraverse.NextNaAndShape;

/*
 * CRISC
 */
public class EDCCircleTraverseRingEventUseIterator extends TraverseRingEvent {
	static Logger logger = Logger
			.getLogger(EDCCircleTraverseRingEventUseIterator.class);

	EDCCircleTraverseRingIterator gtri;

	public EDCCircleTraverseRingEventUseIterator(NeighborAttachment root,
			Ring ring, Message message, Algorithm alg) {
		super(root, ring, message, alg);
		gtri = new EDCCircleTraverseRingIterator(alg, root, ring);
	}
	...
	public void handle() throws SensornetBaseException {
		...
		logger.debug("EDCCircleTraverseRingEventUseIterator start");
		do {
		...
		logger.debug("EDCCircleTraverseRingEventUseIterator end");
	}

	public String toString() {
		StringBuffer sb = new StringBuffer();
		sb.append("EDCCircleTraverseRingEventUseIterator ");

 ...
 * for iwqe
 */
public class IdealCollectDataAroundNodeOrShapeEventForRESACompare extends
		CollectDataInShapeEvent {
	static Logger logger = Logger
			.getLogger(IdealCollectDataAroundNodeOrShapeEventForRESACompare.class);
	protected NeighborAttachment queryNa;
	protected Rect rect; // the collected data must in rect

	public IdealCollectDataAroundNodeOrShapeEventForRESACompare(
	...
	public void handle() throws SensornetBaseException {
		...
		for (int i = 0; i < dataNodes.size(); i++) {
			...
			if (dataNode.isHasSendAnswer())
				...
				this.getAlg().addAnswerAttachment(dataNode, 1);
	...
	public String toString() {
		...
		sb.append("IdealCollectDataAroundNodeOrShapeEventForRESACompare ");

...
import NHSensor.NHSensorSim.shapeTraverse.EDCCircleTraverseRectIteratorCAALinkAwareLifeTime;

public class LinkAwareEDCCircleTraverseRectEventCAAForRESALifeTime extends
		TraverseRectEvent {
	static Logger logger = Logger
			.getLogger(LinkAwareEDCCircleTraverseRectEventCAAForRESALifeTime.class);
	protected int direction;

	public LinkAwareEDCCircleTraverseRectEventCAAForRESALifeTime(Message message,
			Algorithm alg) {
		super(message, alg);
	}

	public LinkAwareEDCCircleTraverseRectEventCAAForRESALifeTime(
	...
	public void handle() throws SensornetBaseException {
		...
		Shape nextShape;
		EDCCircleTraverseRectIteratorCAALinkAwareLifeTime rti = new EDCCircleTraverseRectIteratorCAALinkAwareLifeTime(
		...
		logger.debug("LinkAwareEDCCircleTraverseRectEventCAAForRESALifeTime start");
		do {
		...
		logger.debug("LinkAwareEDCCircleTraverseRectEventCAAForRESALifeTime end");
	}

	public String toString() {
		StringBuffer sb = new StringBuffer();
		sb.append("LinkAwareEDCCircleTraverseRectEventCAAForRESALifeTime ");

 ...
 * for shape traverse
 */
public class CollectDataInShapeViaNodeEventFailureAwareForCSACDA extends
		CollectDataInShapeEvent {
	static Logger logger = Logger
			.getLogger(CollectDataInShapeViaNodeEventFailureAwareForCSACDA.class);
	protected NeighborAttachment queryNa;

	public CollectDataInShapeViaNodeEventFailureAwareForCSACDA(
	...
	public String toString() {
		...
		sb.append("CollectDataInShapeViaNodeEventFailureAwareForCSACDA ");

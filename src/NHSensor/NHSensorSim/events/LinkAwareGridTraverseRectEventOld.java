...
public class LinkAwareGridTraverseRectEventOld extends TraverseRectEvent {
	static Logger logger = Logger
			.getLogger(LinkAwareGridTraverseRectEventOld.class);
	protected int direction;

	public LinkAwareGridTraverseRectEventOld(Message message, Algorithm alg) {
		super(message, alg);
	}

	public LinkAwareGridTraverseRectEventOld(NeighborAttachment root,
	...
	public void handle() throws SensornetBaseException {
		...
		CollectDataInShapeAroundNodeEvent collectDataAroundNodeEvent;
		...
		do {
			...
			collectDataAroundNodeEvent = new CollectDataInShapeAroundNodeEvent(

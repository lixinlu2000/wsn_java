...
public class GreedyForwardToANodeInSectorInRectFarFromPosEvent extends ForwardToShapeEvent {
	protected int direction;
	protected NeighborAttachment firstTryLastNode = null;
	Position pos;
	double radian;
	
	public GreedyForwardToANodeInSectorInRectFarFromPosEvent(NeighborAttachment root,Position pos, double radian,
	...
	public void handle() throws SensornetBaseException {
		...
		GreedyForwardToAnotherNodeInShapeFarFromPosEvent event;
		Message msg = this.getMessage();
		boolean firstTry = true;
		
		while(!destShape.contains(cur.getPos())) {
			event = new GreedyForwardToAnotherNodeInShapeFarFromPosEvent(cur, this.pos, this.radian, destShape, msg, this.getAlg());
	...
	public String toString() {
		...
		sb.append("GreedyForwardToANodeInSectorInRectFarFromPosEvent  ");

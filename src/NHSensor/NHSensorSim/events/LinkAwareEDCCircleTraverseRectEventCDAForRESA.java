...
import NHSensor.NHSensorSim.shapeTraverse.EDCCircleTraverseRectIteratorCDALinkAware;

public class LinkAwareEDCCircleTraverseRectEventCDAForRESA extends
		TraverseRectEvent {
	static Logger logger = Logger
			.getLogger(LinkAwareEDCCircleTraverseRectEventCDAForRESA.class);
	protected int direction;

	public LinkAwareEDCCircleTraverseRectEventCDAForRESA(Message message,
			Algorithm alg) {
		super(message, alg);
	}

	public LinkAwareEDCCircleTraverseRectEventCDAForRESA(
	...
	public void handle() throws SensornetBaseException {
		...
		Shape nextShape;
		EDCCircleTraverseRectIteratorCDALinkAware rti = new EDCCircleTraverseRectIteratorCDALinkAware(
		...
		logger.debug("LinkAwareEDCCircleTraverseRectEventCDAForRESA start");
		do {
		...
		logger.debug("LinkAwareEDCCircleTraverseRectEventCDAForRESA end");
	}

	public String toString() {
		StringBuffer sb = new StringBuffer();
		sb.append("LinkAwareEDCCircleTraverseRectEventCDAForRESA ");

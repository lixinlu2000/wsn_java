 ...
 */
public class CollectDataInShapeViaNodeEventForERISTLinkAware extends
		CollectDataInShapeEvent {
	static Logger logger = Logger
			.getLogger(CollectDataInShapeViaNodeEventForERISTLinkAware.class);
	...
	public CollectDataInShapeViaNodeEventForERISTLinkAware(

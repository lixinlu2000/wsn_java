 ...
 * 
 */
public class ItineraryTraverseRectEvent extends TraverseRectEvent {
	static Logger logger = Logger.getLogger(ItineraryTraverseRectEvent.class);
	protected int direction;

	public ItineraryTraverseRectEvent(Message message, Algorithm alg) {
		super(message, alg);
	}

	public ItineraryTraverseRectEvent(NeighborAttachment root, Rect rect,
	...
	public void handle() throws SensornetBaseException {
		...
		CollectDataAroundNodeOrShapeEvent cde;
		...
		logger.debug("ItineraryTraverseRectEvent start");
		do {
			...
			cde = new CollectDataAroundNodeOrShapeEvent(curNa, nextNa,
		...
		logger.debug("ItineraryTraverseRectEvent end");
	}

	public String toString() {
		StringBuffer sb = new StringBuffer();
		sb.append("ItineraryTraverseRectEvent ");

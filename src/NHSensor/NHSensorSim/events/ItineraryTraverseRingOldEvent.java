...
public class ItineraryTraverseRingOldEvent extends TraverseRingEvent {
	...
	public ItineraryTraverseRingOldEvent(NeighborAttachment root, Ring ring,
	...
	public void handle() throws SensornetBaseException {
		...
		while (true) {
			...
			while (true) {
				...
				// bug
				queryEvent = new BroadcastEvent(curQueryNode, null, this

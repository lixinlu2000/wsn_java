 ...
 * for grid traverse
 */
public class LinkAwareCollectDataInShapeViaNodeEvent extends
		CollectDataInShapeEvent {
	static Logger logger = Logger
			.getLogger(LinkAwareCollectDataInShapeViaNodeEvent.class);
	protected NeighborAttachment queryNa;

	public LinkAwareCollectDataInShapeViaNodeEvent(NeighborAttachment root,
	...
	public void handle() throws SensornetBaseException {
		if (this.queryNa != null) {
			...
			BroadcastEvent queryEvent = new BroadcastEvent(this.root, this
					.getGreedyMessage(), this.shape, this.getAlg());
			queryEvent.setSendQueryTag();
			this.getAlg().getSimulator().handle(queryEvent);
			this.route.add(this.queryNa);
			//
			// LinkAwareGreedyForwardToPointEvent gftpe = new
			// LinkAwareGreedyForwardToPointEvent
			// (this.root,this.queryNa.getNode().getPos(),
			// this.getGreedyMessage(),
			// this.getAlg());
	...
	public String toString() {
		...
		sb.append("LinkAwareCollectDataInShapeViaNodeEvent ");

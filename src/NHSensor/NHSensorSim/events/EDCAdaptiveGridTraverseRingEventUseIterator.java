 ...
 * ERISC
 */
public class EDCAdaptiveGridTraverseRingEventUseIterator extends
		TraverseRingEvent {
	static Logger logger = Logger
			.getLogger(EDCAdaptiveGridTraverseRingEventUseIterator.class);

	EDCAdaptiveGridTraverseRingIterator gtri;

	public EDCAdaptiveGridTraverseRingEventUseIterator(NeighborAttachment root,
	...
	public void handle() throws SensornetBaseException {
		...
		logger.debug("EDCAdaptiveGridTraverseRingEventUseIterator start");
		do {
		...
		logger.debug("EDCAdaptiveGridTraverseRingEventUseIterator end");
	}

	public String toString() {
		StringBuffer sb = new StringBuffer();
		sb.append("EDCAdaptiveGridTraverseRingEventUseIterator ");

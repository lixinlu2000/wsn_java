...
public class DGSANewAlgAverageGridHeightExperiment extends AlgorithmExperiment {
	private AllParam param;
	private double averageGridHeigh;

	public DGSANewAlgAverageGridHeightExperiment(AllParam param) {
		this.param = param;
	...
	public void run() {
		...
		this.averageGridHeigh = drawRectEventAnalyser.getAverageHeight();
		this.isSuccess = this.getAlgorithm().getStatistics().isSuccess();
	}

	public ExperimentResult getResult() {
		// TODO Auto-generated method stub
		return new NumberResult(new Double(this.averageGridHeigh),
				this.isSuccess);
	}
	...
	public double getAverageGridHeight() {
		return this.averageGridHeigh;
	}

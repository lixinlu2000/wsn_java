...
public class RSAParamsFactory {
	...
	double[] queryRegionRateArray = new double[] { 0.01, 0.04, 0.16, 0.2, 0.36,
			0.4, 0.5, 0.64, 0.7, 0.8, 0.9, 1 };

	double gridWidthRate = Constants.IWQE_GRID_WIDTH_RATE;
	double gridWidthRatesBegin = 0.4;
	double gridWidthRatesEnd = 0.99;
	double gridWidthRatesStep = 0.05;

	double radioRange = 30 * Math.sqrt(3);
	double radioRangesBegin = 30;
	double radioRangesEnd = 100;

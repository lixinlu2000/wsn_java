...
public class RSAUtil {
	...
	public static RSAUtil getDefaultRSAUtil() {
		return new RSAUtil();
	}
	...
	public ExperimentParamResultPairCollections chooseNextNodeEnergy(
			String variableName) {
		AllParam param;
		...
		for (int i = 0; i < params.size(); i++) {
			...
			if (this.isShowEachExperimentResult()) {
				System.out.print(" isSuccess(" + experimentDGSANew.isSuccess()
						+ ")" + " DGSANewenergy("
	...
	public ExperimentParamResultPairCollections energyAdjustIWQEWidth(
			String variableName) {
		AllParam param;
		IWQEAlgEnergyExperiment experimentIWQE;
		DGSANewAlgEnergyExperiment experimentDGSANew;
		...
		for (int i = 0; i < params.size(); i++) {
			param = (AllParam) params.elementAt(i);
			experimentIWQE = new IWQEAlgEnergyExperiment(param, true);
			experimentDGSANew = new DGSANewAlgEnergyExperiment(param);
			experimentIWQE.run();
			experimentDGSANew.run();
	...
	public ExperimentParamResultPairCollections robustness(String variableName) {
		...
		for (int i = 0; i < params.size(); i++) {
			...
			// DGSANew Random
			// experimentDGSANewRandom = new
			// DGSANewAlgRobustnessExperiment(param);
			// dGSANewAlgRandom=
			// (DGSANewAlg)(experimentDGSANewRandom.getAlgorithm());
			// dGSANewAlgRandom.setDescription("DGSANewAlgRandom");
			// dGSANewAlgRandom.setChooseNextNodeStrategy(DGSANewAlg.
			...
			if (this.isShowEachExperimentResult()) {
				...
				// experimentDGSANewRandom.isSuccess()
				// + ")" + " DGSANewenergy("
				// + experimentDGSANewRandom.getSuccessProbability() + ")");
			}
		}
		return resultCollections;
	}

	public ExperimentParamResultPairCollections chooseNextNodeRobustness(
			String variableName) {
		AllParam param;
		DGSANewAlgRobustnessExperiment experimentDGSANew;
	...
	public ExperimentParamResultPairCollections successRate(String variableName) {
		...
		for (int i = 0; i < params.size(); i++) {
			...
			// DGSANew Random
			// experimentDGSANewRandom = new
			// DGSANewAlgSuccessRateExperiment(param);
			// dGSANewAlgRandom=
			// (DGSANewAlg)(experimentDGSANewRandom.getAlgorithm());
			// dGSANewAlgRandom.setDescription("DGSANewAlgRandom");
			// dGSANewAlgRandom.setChooseNextNodeStrategy(DGSANewAlg.
			...
			if (this.isShowEachExperimentResult()) {
				...
				System.out.println(" DGSANewisSuccess("
						+ experimentDGSANew.isSuccess() + ")");
				//System.out.println(" DGSANewAlgRandom("+experimentDGSANewRandom
				// .isSuccess()+")");
			}
	...
	public ExperimentParamResultPairCollections averageEnergy(
		...
		for (int i = 0; i < params.size(); i++) {
			...
			// DGSANew Random
			// experimentDGSANewRandom = new
			// DGSANewAlgAverageEnergyExperiment(param);
			// dGSANewAlgRandom=
			// (DGSANewAlg)(experimentDGSANewRandom.getAlgorithm());
			// dGSANewAlgRandom.setDescription("DGSANewAlgRandom");
			// dGSANewAlgRandom.setChooseNextNodeStrategy(DGSANewAlg.
	...
	public ExperimentParamResultPairCollections averageEnergyAdjustIWQEWidth(
			String variableName) {
		AllParam param;
		IWQEAlgAverageEnergyExperiment experimentIWQE;
		DGSANewAlgAverageEnergyExperiment experimentDGSANew;
		...
		for (int i = 0; i < params.size(); i++) {
			param = (AllParam) params.elementAt(i);
			experimentIWQE = new IWQEAlgAverageEnergyExperiment(param, true);
			experimentDGSANew = new DGSANewAlgAverageEnergyExperiment(param);
			experimentIWQE.run();
			experimentDGSANew.run();
	...
	public ExperimentParamResultPairCollections chooseNextNodeAverageEnergy(
			String variableName) {
		AllParam param;
		DGSANewAlgAverageEnergyExperiment experimentDGSANew;
	...
	public void showAndLogAverageEnergyAdjustIWQEWidth(String adjustedVariable,
			String filePath, String xFieldName, String yFieldName,
			String frameTitle, String xAxisLabel, String yAxisLabel,
			String chartTitle) {
		FileAndSceenStream.outputToFile(Util.generateFileName(filePath,
		...
		ExperimentParamResultPairCollections resultCollections = RSAUtil
				.getDefaultRSAUtil().averageEnergyAdjustIWQEWidth(
						adjustedVariable);
	...
	public void showAndLogAverageEnergyChooseNextNode(String adjustedVariable,
			String filePath, String xFieldName, String yFieldName,
			String frameTitle, String xAxisLabel, String yAxisLabel,
			String chartTitle) {
		FileAndSceenStream.outputToFile(Util.generateFileName(filePath,
				xFieldName, yFieldName + "_average"));

		ExperimentParamResultPairCollections resultCollections = RSAUtil
				.getDefaultRSAUtil().chooseNextNodeAverageEnergy(
						adjustedVariable);
		...
		try {
			Util.writeStringToFile(Util.generateMatlabFileName(filePath,
					xFieldName, yFieldName + "_average"), Util
					.experimentsToMatlabPlotProgramme(resultCollections,
							xFieldName, yFieldName, xAxisLabel, yAxisLabel));
		} catch (IOException e) {
			// TODO Auto-generated catch block
	...
	public void showAndLogEnergyAdjustIWQEWidth(String adjustedVariable,
			String filePath, String xFieldName, String yFieldName,
			String frameTitle, String xAxisLabel, String yAxisLabel,
			String chartTitle) {
		FileAndSceenStream.outputToFile(Util.generateFileName(filePath,
		...
		ExperimentParamResultPairCollections resultCollections = RSAUtil
				.getDefaultRSAUtil().energyAdjustIWQEWidth(adjustedVariable);
	...
	public void showAndLogEnergyChooseNextNode(String adjustedVariable,
			String filePath, String xFieldName, String yFieldName,
			String frameTitle, String xAxisLabel, String yAxisLabel,
			String chartTitle) {
		FileAndSceenStream.outputToFile(Util.generateFileName(filePath,
		...
		ExperimentParamResultPairCollections resultCollections = RSAUtil
				.getDefaultRSAUtil().chooseNextNodeEnergy(adjustedVariable);
	...
	public void showAndLogRobustnessChooseNextNode(String adjustedVariable,
			String filePath, String xFieldName, String yFieldName,
			String frameTitle, String xAxisLabel, String yAxisLabel,
			String chartTitle) {
		FileAndSceenStream.outputToFile(Util.generateFileName(filePath,
		...
		ExperimentParamResultPairCollections resultCollections = RSAUtil
				.getDefaultRSAUtil().chooseNextNodeRobustness(adjustedVariable);

...
import NHSensor.NHSensorSim.events.EDCAdaptiveGridTraverseRingEventUseIteratorOld;
...
public class EDCAdaptiveGridTraverseRingEventEnergyExperiment extends
		AlgorithmExperiment {
	...
	public EDCAdaptiveGridTraverseRingEventEnergyExperiment(
			TraverseRingExperimentParam param) {
		this.param = param;
	...
	public void run() {
		...
		EDCAdaptiveGridTraverseRingEventUseIteratorOld e = new EDCAdaptiveGridTraverseRingEventUseIteratorOld(

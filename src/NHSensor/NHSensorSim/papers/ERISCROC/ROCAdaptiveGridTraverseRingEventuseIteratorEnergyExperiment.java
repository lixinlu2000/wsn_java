package NHSensor.NHSensorSim.papers.ERISCROC;

import NHSensor.NHSensorSim.algorithm.GPSRAttachmentAlg;
import NHSensor.NHSensorSim.core.Message;
import NHSensor.NHSensorSim.core.NeighborAttachment;
import NHSensor.NHSensorSim.core.SensorSim;
import NHSensor.NHSensorSim.events.ROCAdaptiveGridTraverseRingEventUseIterator;
...
public class ROCAdaptiveGridTraverseRingEventuseIteratorEnergyExperiment extends
		AlgorithmExperiment {
	...
	public ROCAdaptiveGridTraverseRingEventuseIteratorEnergyExperiment(
			TraverseRingExperimentParam param) {
		this.param = param;
	...
	public void run() {
		...
		ROCAdaptiveGridTraverseRingEventUseIterator e = new ROCAdaptiveGridTraverseRingEventUseIterator(

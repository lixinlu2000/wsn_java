...
public class ExperimentUtil {
	...
	String[] algNames = new String[] { "ERISC", "ROC" };
	...
	public ExperimentParamResultPairCollections energy(String variableName,
		...
		for (int i = 0; i < params.size(); i++) {
			...
			algorithmExperiments[0] = new EDCAdaptiveGridTraverseRingEventEnergyExperiment(
					param);
			algorithmExperiments[1] = new ROCAdaptiveGridTraverseRingEventuseIteratorEnergyExperiment(
					param);

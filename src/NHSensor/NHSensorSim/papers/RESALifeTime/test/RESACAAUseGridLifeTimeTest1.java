...
import NHSensor.NHSensorSim.papers.RESALifeTime.RESACAAUseGridLifeTimeEnergyExperiment;

public class RESACAAUseGridLifeTimeTest1 {
	...
	public static void main(String[] args) {
		...
		RESACAAUseGridLifeTimeEnergyExperiment e = new RESACAAUseGridLifeTimeEnergyExperiment(param);

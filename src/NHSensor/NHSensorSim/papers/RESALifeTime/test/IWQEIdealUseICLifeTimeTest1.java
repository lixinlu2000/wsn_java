...
import NHSensor.NHSensorSim.papers.RESALifeTime.IWQEIdealUseICEnergyExperiment;

public class IWQEIdealUseICLifeTimeTest1 {
	...
	public static void main(String[] args) {
		...
		IWQEIdealUseICEnergyExperiment e = new IWQEIdealUseICEnergyExperiment(param);

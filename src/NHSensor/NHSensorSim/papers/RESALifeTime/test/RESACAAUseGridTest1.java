...
import NHSensor.NHSensorSim.papers.RESALifeTime.RESACAAUseGridEnergyExperiment;

public class RESACAAUseGridTest1 {
	...
	public static void main(String[] args) {
		...
		RESACAAUseGridEnergyExperiment e = new RESACAAUseGridEnergyExperiment(param);

...
import NHSensor.NHSensorSim.papers.RESALifeTime.RESACAALifeTimeEnergyExperiment;

public class RESACAALifeTimeTest1 {
	...
	public static void main(String[] args) {
		...
		RESACAALifeTimeEnergyExperiment e = new RESACAALifeTimeEnergyExperiment(param);

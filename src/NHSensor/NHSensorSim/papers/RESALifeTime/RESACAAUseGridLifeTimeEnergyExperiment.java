...
import NHSensor.NHSensorSim.algorithm.RESACAAUseGridLifeTimeAlg;
...
public class RESACAAUseGridLifeTimeEnergyExperiment extends AlgorithmExperiment {
	AllParam param;
	...
	public RESACAAUseGridLifeTimeEnergyExperiment(AllParam param) {
		this.param = param;
		SensorSim sensorSim = SensorSim.createSensorSim(param);
		sensorSim.getSimulator().addHandleAndTraceEventListener();

		RESACAAUseGridLifeTimeAlg alg = (RESACAAUseGridLifeTimeAlg) sensorSim
				.generateAlgorithm(RESACAAUseGridLifeTimeAlg.NAME);
...
//			this.getAlgorithm().getSimulator().clear();
	...
	public String toString() {
		...
		sb.append("RESACAAUseGridLifeTimeAlg");
		sb.append(" isSuccess(");

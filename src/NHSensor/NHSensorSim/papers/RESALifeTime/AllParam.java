...
public class AllParam extends ExperimentParam {
	...
	public double getInitialEnergyDelta() {
		return initialEnergyDelta;
	}

	public void setInitialEnergyDelta(double initialEnergyDelta) {
		this.initialEnergyDelta = initialEnergyDelta;
	}

...
import NHSensor.NHSensorSim.algorithm.RESACAALifeTimeAlg;
...
public class RESACAALifeTimeEnergyExperiment extends AlgorithmExperiment {
	AllParam param;
	...
	public RESACAALifeTimeEnergyExperiment(AllParam param) {
		this.param = param;
		SensorSim sensorSim = SensorSim.createSensorSim(param);
		sensorSim.getSimulator().addHandleAndTraceEventListener();

		RESACAALifeTimeAlg alg = (RESACAALifeTimeAlg) sensorSim
				.generateAlgorithm(RESACAALifeTimeAlg.NAME);

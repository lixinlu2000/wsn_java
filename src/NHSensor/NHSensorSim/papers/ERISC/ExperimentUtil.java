...
public class ExperimentUtil {
	...
	String[] algNames = new String[] { "ERISC", "IC" };
	...
	public ExperimentParamResultPairCollections energy(String variableName,
		...
		for (int i = 0; i < params.size(); i++) {
			...
			algorithmExperiments[0] = new EDCAdaptiveGridTraverseRingEventUseIteratorEnergyExperiment(
					param);
			algorithmExperiments[1] = new IWQETraverseRingEventUseIteratorEnergyExperiment(
					param);

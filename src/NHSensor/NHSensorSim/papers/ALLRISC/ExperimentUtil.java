...
public class ExperimentUtil {
	...
	final int ALG_COUNT = 4;
	String[] algNames = new String[] { "CRISC", "ERISC", "ROC", "IC" };
	...
	public ExperimentParamResultPairCollections energy(String variableName,
		...
		for (int i = 0; i < params.size(); i++) {
			...
			algorithmExperiments[1] = new EDCAdaptiveGridTraverseRingEventEnergyExperiment(
					param);
			algorithmExperiments[2] = new ROCAdaptiveGridTraverseRingEventuseIteratorEnergyExperiment(
					param);
			algorithmExperiments[3] = new IWQETraverseRingEventEnergyExperiment(
					param);

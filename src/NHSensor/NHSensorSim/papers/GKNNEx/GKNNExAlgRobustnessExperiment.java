...
import NHSensor.NHSensorSim.algorithm.GKNNExAlg;
...
public class GKNNExAlgRobustnessExperiment extends AlgorithmExperiment {
	private AllParam param;
	private RobustnessResult robustnessResult;

	public GKNNExAlgRobustnessExperiment(AllParam param) {
		this.param = param;
		SensorSim sensorSim = SensorSim.createKNNSensorSim(param);
		sensorSim.getSimulator().addHandleAndTraceEventListener();

		GKNNExAlg alg = (GKNNExAlg) sensorSim.generateAlgorithm(GKNNExAlg.NAME);

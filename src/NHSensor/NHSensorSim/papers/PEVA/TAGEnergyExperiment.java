...
import NHSensor.NHSensorSim.algorithm.TAGNewAlg;
...
public class TAGEnergyExperiment extends AlgorithmExperiment {
	AllParam param;
	...
	public TAGEnergyExperiment(AllParam param) {
		this.param = param;
		SensorSim sensorSim = SensorSim.createSensorSim(param);
		sensorSim.getSimulator().addHandleAndTraceEventListener();

		TAGNewAlg alg = (TAGNewAlg) sensorSim.generateAlgorithm(TAGNewAlg.NAME);
	...
	public TAGEnergyExperiment(AllParam param, Network network) {
		this.param = param;

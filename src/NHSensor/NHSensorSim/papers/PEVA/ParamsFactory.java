...
public class ParamsFactory {
	...
	int queryMessageSize = 2;
	int queryMessageSizeBegin = 2;
	int queryMessageSizeEnd = 10;
	int queryMessageSizeStep = 2;

	int senseDataSize = 4;
	int senseDataSizeBegin = 2;
	int senseDataSizeEnd = 32;
	int senseDataSizeStep = 2;

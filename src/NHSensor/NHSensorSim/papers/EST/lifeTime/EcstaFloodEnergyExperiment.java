...
public class EcstaFloodEnergyExperiment extends AlgorithmExperiment {
	AllParam param;
	...
	public EcstaFloodEnergyExperiment(AllParam param) {
		this.param = param;
		SensorSim sensorSim = SensorSim.createSensorSim(param);
		sensorSim.getSimulator().addHandleAndTraceEventListener();

		EcstaAlg alg = (EcstaAlg) sensorSim.generateAlgorithm(EcstaAlg.NAME);

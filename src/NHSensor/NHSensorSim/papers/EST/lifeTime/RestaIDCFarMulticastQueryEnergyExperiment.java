...
public class RestaIDCFarMulticastQueryEnergyExperiment extends
		AlgorithmExperiment {
	AllParam param;
	...
	public RestaIDCFarMulticastQueryEnergyExperiment(AllParam param) {
		this.param = param;
	...
	public String toString() {
		...
		sb.append("RestaIDCFarMulticastQuery");
		sb.append(" isSuccess(");

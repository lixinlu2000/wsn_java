...
import NHSensor.NHSensorSim.algorithm.RestaFarMulticastQueryAlg;
...
public class RestaFarMulticastQueryPartitionByAreaEnergyExperiment extends
		AlgorithmExperiment {
	AllParam param;
	...
	public RestaFarMulticastQueryPartitionByAreaEnergyExperiment(AllParam param) {
		this.param = param;
		SensorSim sensorSim = SensorSim.createSensorSim(param);
		sensorSim.getSimulator().addHandleAndTraceEventListener();

		RestaFarMulticastQueryAlg alg = (RestaFarMulticastQueryAlg) sensorSim
				.generateAlgorithm(RestaFarMulticastQueryAlg.NAME);
	...
	public void run() {
		...
		// this.queryNodeNum =
		// ((RestaFarMulticastQueryAlg)this.getAlgorithm()).getQueryNodeNum();
	}
	...
	public String toString() {
		...
		sb.append("RestaFarMulticastQuery");
		sb.append(" isSuccess(");

...
public class ItineraryTraverseRingEventAverageEnergyExperiment extends
		AlgorithmExperiment {
	...
	public ItineraryTraverseRingEventAverageEnergyExperiment(
			TraverseRingExperimentParam param) {
		this.param = param;
	...
	public void run() {
		...
		ItineraryTraverseRingEvent e = new ItineraryTraverseRingEvent(root,
				ring, queryMesage, this.getAlgorithm());

...
public class ESAEnergyExperiment extends AlgorithmExperiment {
	AllParam param;
	...
	public ESAEnergyExperiment(AllParam param) {
		this.param = param;
		SensorSim sensorSim = SensorSim.createSensorSim(param);
		sensorSim.getSimulator().addHandleAndTraceEventListener();

		ESAAlg alg = (ESAAlg) sensorSim.generateAlgorithm(ESAAlg.NAME);
	...
	public void run() {
		...
		this.queryNodeNum = ((ESAAlg) this.getAlgorithm()).getQueryNodeNum();
	}

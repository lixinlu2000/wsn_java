...
import NHSensor.NHSensorSim.algorithm.E2STAFinalAlg;
...
public class E2STAFinalFullFloodEnergyExperiment extends AlgorithmExperiment {
	AllParam param;
	...
	public E2STAFinalFullFloodEnergyExperiment(AllParam param) {
		this.param = param;
		SensorSim sensorSim = SensorSim.createSensorSim(param);
		sensorSim.getSimulator().addHandleAndTraceEventListener();

		alg1 = (FullFloodAlg) sensorSim.generateAlgorithm(FullFloodAlg.NAME);
		...
		E2STAFinalAlg alg = (E2STAFinalAlg) sensorSim.generateAlgorithm(E2STAFinalAlg.NAME);

...
public class E2STAExEcstaFloodEnergyExperiment extends AlgorithmExperiment {
	AllParam param;
	...
	public E2STAExEcstaFloodEnergyExperiment(AllParam param) {
		this.param = param;
	...
	public String toString() {
		...
		sb.append("E2STAExEcstaFloodCompare");
		sb.append(" isSuccess(");

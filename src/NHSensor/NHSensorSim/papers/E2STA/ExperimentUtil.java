...
public class ExperimentUtil {
	...
	String[] algNames = new String[] { "FullFlood", "SWinFlood", "SWIF",
			"EST_MQP_IDC", "EST_MQP_IDC_ByArea", "E2STAOriginal", "E2STAEx", "E2STA", "E2STAHyperbola", "E2STAExSameSita"};
	boolean[] algRunOrNot = new boolean[] { true, true, true, true, true, true, true, true, true};
	...
	public ExperimentParamResultPairCollections energy(String variableName,
		...
		for (int i = 0; i < params.size(); i++) {
			...
			if (algRunOrNot[7])
				algorithmExperiments[7] = new E2STAFinalEnergyExperiment(param);
			if (algRunOrNot[8])
				algorithmExperiments[8] = new E2STAHyperbolaEnergyExperiment(param);
			if (algRunOrNot[9])
				algorithmExperiments[9] = new E2STAExSameASitaEnergyExperiment(param);

...
public class E2STAExAlgTest4 {
	...
	public static void main(String[] args) {
		...
		String paramString = "answerMessageSize(200) nodeNum(480) nodeFailProbability(0.667) queryMessageSize(50) networkHeight(100.0) networkID(23) k(0) nodeFailModelID(0) networkWidth(100.0) gridWidthRate(5) resultSize(200) queryAndPatialAnswerSize(250) failNodeNum(0) queryRegionRate(0.8) radioRange(10.0)";
		AllParam param;
		try {

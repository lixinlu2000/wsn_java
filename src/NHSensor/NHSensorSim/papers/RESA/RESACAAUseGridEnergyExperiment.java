...
public class RESACAAUseGridEnergyExperiment extends AlgorithmExperiment {
	AllParam param;
	...
	public RESACAAUseGridEnergyExperiment(AllParam param) {
		this.param = param;
		SensorSim sensorSim = SensorSim.createSensorSim(param);
		sensorSim.getSimulator().addHandleAndTraceEventListener();

		RESACAAUseGridAlg alg = (RESACAAUseGridAlg) sensorSim
				.generateAlgorithm(RESACAAUseGridAlg.NAME);
	...
	public void run() {
		...
		this.queryNodeNum = ((RESACAAUseGridAlg) this.getAlgorithm())
				.getQueryNodeNum();
	}

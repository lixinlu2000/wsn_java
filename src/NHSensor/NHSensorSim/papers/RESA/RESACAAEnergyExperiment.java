...
public class RESACAAEnergyExperiment extends AlgorithmExperiment {
	AllParam param;
	...
	public RESACAAEnergyExperiment(AllParam param) {
		this.param = param;
		SensorSim sensorSim = SensorSim.createSensorSim(param);
		sensorSim.getSimulator().addHandleAndTraceEventListener();

		RESACAAAlg alg = (RESACAAAlg) sensorSim
				.generateAlgorithm(RESACAAAlg.NAME);
	...
	public void run() {
		...
		this.queryNodeNum = ((RESACAAAlg) this.getAlgorithm())
				.getQueryNodeNum();
	}

...
public class LACTest2 {
	...
	public static void main(String[] args) {
		...
		String paramString = "d0(1.0) networkWidth(100.0) preambleLength(0.0) radioRange(20.0) encodingRatio(1.0) pld0(55.0) nodeNum(320) networkID(1) sigma(4.0) pt(0.0) ringWidth(17.0) n(4.0) queryMessageSize(10) networkHeight(100.0) pn(-105.0) answerMessageSize(35) ringLowRadius(20.0) frameLength(50.0) linkID(0)";

...
public class ICTest3 {
	...
	public static void main(String[] args) {
		...
		String paramString = "d0(1.0) networkWidth(100.0) preambleLength(0.0) maxHoleRadius(15.0) radioRange(14.0) nodeNum(320) encodingRatio(1.0) pld0(55.0) networkID(1) sigma(4.0) pt(0.0) ringWidth(10.0) n(4.0) queryMessageSize(10) networkHeight(100.0) pn(-105.0) holeModelID(1) holeNumber(0) answerMessageSize(30) ringLowRadius(20.0) frameLength(50.0) linkID(0)";

...
public class IWQETraverseRingEventUseIteratorLinkAwareEnergyExperiment extends
	...
	public void run() {
		...
		Message message = new Message(param.getQueryMessageSize(), null);
		...
		if(this.getAlgorithm().getStatistics().getQueryResultCorrectness().isQueryResultCorrect(0.95)) {
			this.isSuccess = true;
		}

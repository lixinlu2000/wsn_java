...
public class ExperimentUtil {
	...
	String[] algNames = new String[] { "FullFlood", "SWIF", "HSANoApproximate", "GRT", "HSA"};
	...
	public ExperimentParamResultPairCollections energy(String variableName,
		...
		for (int i = 0; i < params.size(); i++) {
			...
			if (algRunOrNot[1])
				algorithmExperiments[1] = new EcstaFloodEnergyExperiment(param);
			if (algRunOrNot[2])
				algorithmExperiments[2] = new HSAEnergyExperiment(param);
			if (algRunOrNot[3])
				algorithmExperiments[3] = new GRTEnergyExperiment(param);
			if (algRunOrNot[4])
				algorithmExperiments[4] = new HSAApproximateEnergyExperiment(param);

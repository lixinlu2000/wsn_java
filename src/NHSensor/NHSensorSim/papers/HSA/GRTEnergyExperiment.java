...
import NHSensor.NHSensorSim.algorithm.GRTAlg;
...
public class GRTEnergyExperiment extends AlgorithmExperiment {
	AllParam param;
	...
	public GRTEnergyExperiment(AllParam param) {
		this.param = param;
		SensorSim sensorSim = SensorSim.createSensorSim(param);
		sensorSim.getSimulator().addHandleAndTraceEventListener();

		GRTAlg alg = (GRTAlg) sensorSim
				.generateAlgorithm(GRTAlg.NAME);

...
public class HSAEnergyExperiment extends AlgorithmExperiment {
	AllParam param;
	...
	public HSAEnergyExperiment(AllParam param) {
		this.param = param;
		SensorSim sensorSim = SensorSim.createSensorSim(param);
		sensorSim.getSimulator().addHandleAndTraceEventListener();

		HSAAlg alg = (HSAAlg) sensorSim.generateAlgorithm(HSAAlg.NAME);

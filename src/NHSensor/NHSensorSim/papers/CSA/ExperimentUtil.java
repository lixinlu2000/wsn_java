...
public class ExperimentUtil {
	...
	String[] algNames = new String[] { "ASA_CA", "ASA_LA", "IWQE" };
	// String[] algNames = new String[] {"CSACDA","ESAGBA"};
	AlgorithmExperiment[] algorithmExperiments = new AlgorithmExperiment[ALG_COUNT];
	boolean[] algRunOrNot = new boolean[] { true, true, true};
	...
	public ExperimentParamResultPairCollections energy(String variableName,
		...
		for (int i = 0; i < params.size(); i++) {
			...
			if (algRunOrNot[2])
				algorithmExperiments[2] = new IWQEIdealUseICEnergyExperimentHasFailNodes(
					param);

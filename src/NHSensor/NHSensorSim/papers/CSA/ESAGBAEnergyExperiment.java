...
public class ESAGBAEnergyExperiment extends AlgorithmExperiment {
	AllParam param;
	...
	public ESAGBAEnergyExperiment(AllParam param) {
		...
		ESAUseGBAFailureAwareFinalAlg alg = (ESAUseGBAFailureAwareFinalAlg) sensorSim
				.generateAlgorithm(ESAUseGBAFailureAwareFinalAlg.NAME);
	...
	public void run() {
		...
		this.queryNodeNum = ((ESAUseGBAFailureAwareFinalAlg) this

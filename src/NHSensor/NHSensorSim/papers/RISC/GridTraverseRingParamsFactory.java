...
public class GridTraverseRingParamsFactory {
	int nodeNum = 1600;
	SequenceInfo nodeNumInfo = new SequenceInfo(400, 2400, 400);

	/*
	 * int queryMessageSize = 35; SequenceInfo queryMessageSizeInfo = new
	 * SequenceInfo(30,60,5);
	 * 
	 * int senseDataSize = 10; SequenceInfo senseDataSizeInfo = new
	 * SequenceInfo(5,30,5);
	 */
	...
	double nodeFailProbability = 0.15;
	...
	public GridTraverseRingParamsFactory() {
	}

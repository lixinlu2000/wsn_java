...
/*
 * The difference between GridTraverseRingParamsNewFactory and
 * GridTraverseRingParamsFactory is the sita in 
 * GridTraverseRingParamsNewFactory is bigger!!!
 */
public class GridTraverseRingParamsBigSitaFactory extends
		GridTraverseRingParamsFactory {
	int nodeNum = 750;
	SequenceInfo nodeNumInfo = new SequenceInfo(250, 1250, 250);

	int queryMessageSize = 35;
	SequenceInfo queryMessageSizeInfo = new SequenceInfo(30, 40, 2);

	int senseDataSize = 5;
	SequenceInfo senseDataSizeInfo = new SequenceInfo(5, 10, 1);
	...
	int networkID = 1;
	SequenceInfo networkIDInfo = new SequenceInfo(1, 5, 1);

	double nodeFailProbability = 0.01;
	SequenceInfo nodeFailProbabilityInfo = new SequenceInfo(0.02, 0.3, 0.03);

	double ringLowRadius = 60;
	SequenceInfo ringLowRadiusInfo = new SequenceInfo(10, 100, 10);

	double ringWidth = 45;
	SequenceInfo ringWidthInfo = new SequenceInfo(5, 45, 5);

	double sita;
	int sitasSize = 5;
	SequenceInfo sitaInfo;

	public GridTraverseRingParamsBigSitaFactory() {
	}

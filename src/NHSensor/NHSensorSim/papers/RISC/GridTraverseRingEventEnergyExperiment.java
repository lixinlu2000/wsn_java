...
public class GridTraverseRingEventEnergyExperiment extends AlgorithmExperiment {
	TraverseRingExperimentParam param;
	double consumedEnergy = 0;
	NeighborAttachment root;
	Ring ring;

	public GridTraverseRingEventEnergyExperiment(
			TraverseRingExperimentParam param) {
		this.param = param;
	...
	public void run() {
		...
		GridTraverseRingEvent e = new GridTraverseRingEvent(root, ring, this
				.getParam().getSita(), queryMesage, this.getAlgorithm());

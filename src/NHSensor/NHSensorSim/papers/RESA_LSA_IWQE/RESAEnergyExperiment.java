...
public class RESAEnergyExperiment extends AlgorithmExperiment {
	AllParam param;
	...
	public RESAEnergyExperiment(AllParam param) {
		this.param = param;
		SensorSim sensorSim = SensorSim.createSensorSim(param);
		sensorSim.getSimulator().addHandleAndTraceEventListener();

		RESAAlg alg = (RESAAlg) sensorSim.generateAlgorithm(RESAAlg.NAME);
	...
	public void run() {
		...
		this.queryNodeNum = ((RESAAlg) this.getAlgorithm()).getQueryNodeNum();
	}

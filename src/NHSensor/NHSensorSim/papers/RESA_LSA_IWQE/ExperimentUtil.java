...
public class ExperimentUtil {
	...
	// String[] algNames = new String[] {"IWQE","RESAUseGrid","RESA"};
	final int ALG_COUNT = 4;
	String[] algNames = new String[] { "IWQE", "RESAUseGrid", "RESA", "LSA" };
	...
	public ExperimentParamResultPairCollections energy(String variableName,
		...
		for (int i = 0; i < params.size(); i++) {
			...
			algorithmExperiments[3] = new LSAEnergyExperiment(param);

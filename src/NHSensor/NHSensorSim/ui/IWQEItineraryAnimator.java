...
public class IWQEItineraryAnimator extends Animator {
	/**
	 * 
	 */
	private static final long serialVersionUID = -1499673757914108914L;

	public IWQEItineraryAnimator() {
		// TODO Auto-generated constructor stub
	}

	public IWQEItineraryAnimator(Algorithm algorithm) {
		super(algorithm);
		// TODO Auto-generated constructor stub
	}
	...
	public static void main(String[] args) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				Animator animator = new IWQEItineraryAnimator();
				animator.start();
			}
		});
	}

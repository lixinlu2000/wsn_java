...
public class EventsEnergyList extends JList implements SensornetView {
	/**
	 * 
	 */
	...
	public EventsEnergyList(SensornetModel sensornetModel) {
	...
	public void updateSensornetView() {
		...
		for (int i = 0; i < events.size(); i++) {
			...
			if (event instanceof BroadcastEvent) {
				energy = ((BroadcastEvent) event).getConsumedEnergy();

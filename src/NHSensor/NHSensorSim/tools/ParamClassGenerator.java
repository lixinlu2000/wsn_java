...
public class ParamClassGenerator {
	...
	public static String generate(String packageString, String className, ParamAttribute[] paramAttributes) {
		...
		for(int i=0;i<paramAttributes.length;i++) {
			classCode.append("\t");
			classCode.append(paramAttributes[i].getType());
			classCode.append(" ");
			classCode.append(paramAttributes[i].getName());
			if(!paramAttributes[i].isAdjustable()) {
				classCode.append(" = ");
				classCode.append(paramAttributes[i].getDefaultValue());
			}
			classCode.append(";\n");
		}
		classCode.append("\n");
	...
	public static String generateSetMethodCode(ParamAttribute paramAttribute) {
		...
		code.append("\t\tthis."+paramName+" = "+paramName+";\n");
		code.append("\t}\n");

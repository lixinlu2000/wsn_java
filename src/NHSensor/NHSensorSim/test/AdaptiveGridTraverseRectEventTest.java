...
public class AdaptiveGridTraverseRectEventTest {
	...
	public static void main(String[] args) {
		...
		AdaptiveGridTraverseRectEvent e = new AdaptiveGridTraverseRectEvent(

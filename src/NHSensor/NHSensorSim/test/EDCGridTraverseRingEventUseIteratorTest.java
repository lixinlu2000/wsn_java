...
import NHSensor.NHSensorSim.events.EDCGridTraverseRingEventUseIterator;
import NHSensor.NHSensorSim.shape.Ring;
import NHSensor.NHSensorSim.ui.Animator;

public class EDCGridTraverseRingEventUseIteratorTest {
	...
	public static void main(String[] args) {
		...
		Ring ring = new Ring(alg.getNetwork().getRect().getCentre(), 100, 150);
		DrawShapeEvent drawShapeEvent = new DrawShapeEvent(alg, ring);
		alg.run(drawShapeEvent);

		Message mesage = new Message(10, null);
		EDCGridTraverseRingEventUseIterator e = new EDCGridTraverseRingEventUseIterator(

...
import NHSensor.NHSensorSim.events.GridTraverseRingEventUseIterator;
import NHSensor.NHSensorSim.shape.Ring;
import NHSensor.NHSensorSim.ui.Animator;

public class GridTraverseRingEventUseIteratorTest {
	...
	public static void main(String[] args) {
		...
		GridTraverseRingEventUseIterator e = new GridTraverseRingEventUseIterator(
				root, ring, GKNNUtil.calculateRingSectorSita(ring
						.getLowRadius(), ring.getHighRadius(), alg.getParam()
						.getRADIO_RANGE()), queryMesage, alg);
		// DrawShapesEvent drawShapesEvent =
		// new DrawShapesEvent(alg,e.getRingSectors());

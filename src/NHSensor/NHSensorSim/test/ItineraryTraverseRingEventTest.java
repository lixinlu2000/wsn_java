...
public class ItineraryTraverseRingEventTest {
	...
	public static void main(String[] args) {
		...
		ItineraryTraverseRingEvent e = new ItineraryTraverseRingEvent(root,
				ring, queryMesage, alg);
		alg.run(e);
		sensorSim.printStatistic();
		/*
		 * DrawShapesEvent drawShapesEvent = new
		 * DrawShapesEvent(alg,e.getRingSectors()); alg.run(drawShapesEvent);
		 */

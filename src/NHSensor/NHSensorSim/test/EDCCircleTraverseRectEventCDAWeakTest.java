...
import NHSensor.NHSensorSim.events.EDCCircleTraverseRectEventCDAWeak;
import NHSensor.NHSensorSim.shape.Rect;
import NHSensor.NHSensorSim.shapeTraverse.Direction;
import NHSensor.NHSensorSim.ui.Animator;

public class EDCCircleTraverseRectEventCDAWeakTest {
	...
	public static void main(String[] args) {
		...
		SensorSim sensorSim = SensorSim.createSensorSim(3, 450, 450, 800);
		...
		EDCCircleTraverseRectEventCDAWeak e = new EDCCircleTraverseRectEventCDAWeak(

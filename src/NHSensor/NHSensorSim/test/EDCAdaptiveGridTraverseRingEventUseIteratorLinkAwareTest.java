...
import NHSensor.NHSensorSim.events.EDCAdaptiveGridTraverseRingEventUseIteratorLinkAware;
import NHSensor.NHSensorSim.link.LinkEstimatorFactory;
import NHSensor.NHSensorSim.shape.Ring;
import NHSensor.NHSensorSim.ui.Animator;

public class EDCAdaptiveGridTraverseRingEventUseIteratorLinkAwareTest {
	...
	public static void main(String[] args) {
		...
		SensorSim sensorSim = SensorSim.createSensorSim(1, 450, 450, 600, 0.36);
		...
		EDCAdaptiveGridTraverseRingEventUseIteratorLinkAware e = new EDCAdaptiveGridTraverseRingEventUseIteratorLinkAware(

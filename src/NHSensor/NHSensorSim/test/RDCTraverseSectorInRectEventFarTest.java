...
public class RDCTraverseSectorInRectEventFarTest {
	...
	public static void main(String[] args) {
		...
		double sita = Math.PI / 20;
		Sector sector = new Sector(root.getPos(), startRadian, sita);
		...
		RDCTraverseSectorInRectEventFar e = new RDCTraverseSectorInRectEventFar(
				root, sectorInRect, queryAndPatialAnswerMesage, alg);
		alg.run(e);
		sensorSim.printStatistic();

...
public class GreedyForwardToAllNodesInShapeTest {
	...
	public static void main(String[] args) {
		...
		GreedyForwardToAllNodeInShapeEvent e = new GreedyForwardToAllNodeInShapeEvent(
				root, ringSector, new Message(10, null), alg);
		alg.run(e);

...
public class EDCGridTraverseRectEventGAATest {
	...
	public static void main(String[] args) {
		...
		EDCGridTraverseRectEventGAA e = new EDCGridTraverseRectEventGAA(root,
				rect, Direction.DOWN, queryAndPatialAnswerMesage, true, alg);
		alg.run(e);
		sensorSim.printStatistic();

...
import NHSensor.NHSensorSim.events.GridTraverseRectEvent;
import NHSensor.NHSensorSim.shape.Rect;
import NHSensor.NHSensorSim.shapeTraverse.Direction;
import NHSensor.NHSensorSim.ui.Animator;

public class GridTraverseRectEventTest {
	...
	public static void main(String[] args) {
		...
		GridTraverseRectEvent e = new GridTraverseRectEvent(root, rect,
				Direction.DOWN, queryAndPatialAnswerMesage, true, alg);
		alg.run(e);
		sensorSim.printStatistic();

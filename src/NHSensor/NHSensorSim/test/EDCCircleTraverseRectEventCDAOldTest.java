...
import NHSensor.NHSensorSim.events.EDCCircleTraverseRectEventCDAOld;
import NHSensor.NHSensorSim.shape.Rect;
import NHSensor.NHSensorSim.shapeTraverse.Direction;
import NHSensor.NHSensorSim.ui.Animator;

public class EDCCircleTraverseRectEventCDAOldTest {
	...
	public static void main(String[] args) {
		...
		EDCCircleTraverseRectEventCDAOld e = new EDCCircleTraverseRectEventCDAOld(

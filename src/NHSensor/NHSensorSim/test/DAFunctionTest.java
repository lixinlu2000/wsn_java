...
public class DAFunctionTest {
	...
	public static void main(String[] args) {
		...
		DAFunction daFunction = new DAFunction(centre, rect);
		// ChartFrame.showUnivariateRealFunction(daFunction, 0,
		// daFunction.getMax(), 1*Math.PI/180);
		ChartFrame.showUnivariateRealFunction(daFunction, 0, 2.25,
				1 * Math.PI / 180);

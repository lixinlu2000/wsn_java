...
import NHSensor.NHSensorSim.events.LineTraverseRingEventLinkAware;
import NHSensor.NHSensorSim.shape.Ring;
import NHSensor.NHSensorSim.ui.Animator;

public class LineTraverseRingEventLinkAwareTest {
	...
	public static void main(String[] args) {
		...
		SensorSim sensorSim = SensorSim.createSensorSim(4, 450, 450, 400, 0.36);
		...
		LineTraverseRingEventLinkAware e = new LineTraverseRingEventLinkAware(
				root, ring, mesage, alg);
		alg.run(e);
		sensorSim.printStatistic();
		System.out.println("QueryNodeNum:" + e.getQueryNodeNum());

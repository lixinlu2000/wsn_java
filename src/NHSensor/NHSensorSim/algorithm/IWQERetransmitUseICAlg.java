 ...
 */
public class IWQERetransmitUseICAlg extends IWQEAlg {
	static Logger logger = Logger.getLogger(IWQERetransmitUseICAlg.class);

	public static final String NAME = "IWQERetransmitUseICAlg";
	...
	public IWQERetransmitUseICAlg(Query query, Network network,

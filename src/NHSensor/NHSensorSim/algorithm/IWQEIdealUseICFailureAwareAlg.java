 ...
 */
public class IWQEIdealUseICFailureAwareAlg extends IWQEAlg {
	static Logger logger = Logger
			.getLogger(IWQEIdealUseICFailureAwareAlg.class);

	public static final String NAME = "IWQEIdealUseICFailureAware";
	...
	public IWQEIdealUseICFailureAwareAlg(Query query, Network network,
	...
	public IWQEIdealUseICFailureAwareAlg() {
		// TODO Auto-generated constructor stub
	}
	...
	public boolean run() {
		try {
			...
			for (int subQueryRegionIndex = 0; subQueryRegionIndex < this.subQueryRegions
				...
				DrawRectEvent dse = new DrawRectEvent(this, subQueryRegion);

...
import NHSensor.NHSensorSim.events.ItineraryTraverseRectEventUseLinkAwareRouting;
 ...
 * geographic routing use link aware routing!!!!
 * the former query node send quey and partial answer message to the next query node!
 */
public class IWQEIdealUseICAndLinkAwareRoutingAlg extends IWQEAlg {
	static Logger logger = Logger
			.getLogger(IWQEIdealUseICAndLinkAwareRoutingAlg.class);

	public static final String NAME = "IWQEIdealUseICAndLinkAwareRouting";
	...
	public IWQEIdealUseICAndLinkAwareRoutingAlg(Query query, Network network,
	...
	public IWQEIdealUseICAndLinkAwareRoutingAlg() {
		// TODO Auto-generated constructor stub
	}
	...
	public boolean run() {
		try {
			...
			Message answerMessage = new Message(this.getParam()
					.getANSWER_SIZE(), null);
			...
			for (int subQueryRegionIndex = 0; subQueryRegionIndex < this.subQueryRegions
				...
				ItineraryTraverseRectEventUseLinkAwareRouting e = new ItineraryTraverseRectEventUseLinkAwareRouting(

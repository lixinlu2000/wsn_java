...
import NHSensor.NHSensorSim.events.IdealItineraryTraverseRectEventForRESACompare;
 ...
 * for resa compare
 */
public class IWQEIdealUseICForRESACompareAlg extends IWQEAlg {
	static Logger logger = Logger
			.getLogger(IWQEIdealUseICForRESACompareAlg.class);

	public static final String NAME = "IWQEIdealUseICForRESACompare";
	...
	public IWQEIdealUseICForRESACompareAlg(Query query, Network network,
	...
	public IWQEIdealUseICForRESACompareAlg() {
		// TODO Auto-generated constructor stub
	}
	...
	public boolean run() {
		try {
			...
			for (int subQueryRegionIndex = 0; subQueryRegionIndex < this.subQueryRegions
				...
				IdealItineraryTraverseRectEventForRESACompare e = new IdealItineraryTraverseRectEventForRESACompare(

...
import NHSensor.NHSensorSim.events.EDCGridTraverseRectEventGAA;
...
public class ESAUseGAAAlg extends IWQEAlg {
	static Logger logger = Logger.getLogger(ESAUseGAAAlg.class);

	public static final String NAME = "ESAUseGAA";
	private Vector rects = new Vector();

	public ESAUseGAAAlg(Query query, Network network, Simulator simulator,
	...
	public ESAUseGAAAlg(Query query, Network network, Simulator simulator,
		...
		super(query, network, simulator, param, ESAUseGAAAlg.NAME, statistics);
		// TODO Auto-generated constructor stub
	}
	...
	public boolean gridTraverse() throws SensornetBaseException {
		...
		EDCGridTraverseRectEventGAA edcEvent;

		for (int i = 0; i < this.subQueryRegionNum; i++) {
			Rect subQueryRegion = (Rect) this.subQueryRegions.elementAt(i);
			edcEvent = new EDCGridTraverseRectEventGAA(cur, subQueryRegion,

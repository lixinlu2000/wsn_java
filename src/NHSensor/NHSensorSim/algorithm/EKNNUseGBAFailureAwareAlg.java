...
public class EKNNUseGBAFailureAwareAlg extends GPSRAlg {
	static Logger logger = Logger.getLogger(EKNNUseGBAFailureAwareAlg.class);

	public static final String NAME = "EKNNUseGBAFailureAware";
	...
	public EKNNUseGBAFailureAwareAlg(QueryBase query) {
		super(query);
		// TODO Auto-generated constructor stub
	}

	public EKNNUseGBAFailureAwareAlg(KNNQuery query, Network network,
	...
	public EKNNUseGBAFailureAwareAlg(KNNQuery query, Network network,
		...
		super(query, network, simulator, param, EKNNUseGBAFailureAwareAlg.NAME,
				statistics);
		// TODO Auto-generated constructor stub
	}

	public EKNNUseGBAFailureAwareAlg() {
		// TODO Auto-generated constructor stub
	}

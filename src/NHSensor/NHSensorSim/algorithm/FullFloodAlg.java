...
public class FullFloodAlg extends AbstractTreeAlg {
	public final static String NAME = "FullFlood";
	protected TreeEvent treeEvent;

	public FullFloodAlg(Query query, Network network, Simulator simulator,
			Param param, String name, Statistics statistics) {
		super(query, network, simulator, param, name, statistics);
	}

	public FullFloodAlg(Query query) {
		super(query);
	}

	public FullFloodAlg(Query query, Network network, Simulator simulator,
			Param param, Statistics statistics) {
		super(query, network, simulator, param, FullFloodAlg.NAME, statistics);
	}

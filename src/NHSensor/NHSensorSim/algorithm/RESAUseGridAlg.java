...
import NHSensor.NHSensorSim.events.LinkAwareEDCGridTraverseRectEventCDAForRESA;
...
/*
 * RESA take advantage of GRID traverse
 */
public class RESAUseGridAlg extends IWQEAlg {
	static Logger logger = Logger.getLogger(RESAUseGridAlg.class);

	public static final String NAME = "RESAUseGrid";
	...
	public RESAUseGridAlg(Query query, Network network, Simulator simulator,
	...
	public boolean run() {
		try {
			...
			for (int subQueryRegionIndex = 0; subQueryRegionIndex < this.subQueryRegions
				...
				LinkAwareEDCGridTraverseRectEventCDAForRESA e = new LinkAwareEDCGridTraverseRectEventCDAForRESA(

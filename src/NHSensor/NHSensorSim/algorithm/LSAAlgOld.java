...
public class LSAAlgOld extends IWQEAlg {
	static Logger logger = Logger.getLogger(LSAAlgOld.class);
	...
	public LSAAlgOld(Query query, Network network, Simulator simulator,

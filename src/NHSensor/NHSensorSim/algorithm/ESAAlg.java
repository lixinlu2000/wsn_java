...
import NHSensor.NHSensorSim.events.EDCGridTraverseRectNewEvent;
...
public class ESAAlg extends IWQEAlg {
	static Logger logger = Logger.getLogger(ESAAlg.class);

	public static final String NAME = "ESANew";
	private Vector rects = new Vector();

	public ESAAlg(Query query, Network network, Simulator simulator,
	...
	public ESAAlg(Query query, Network network, Simulator simulator,
		...
		super(query, network, simulator, param, ESAAlg.NAME, statistics);
		// TODO Auto-generated constructor stub
	}
	...
	public boolean gridTraverse() throws SensornetBaseException {
		...
		EDCGridTraverseRectNewEvent edcEvent;

		for (int i = 0; i < this.subQueryRegionNum; i++) {
			Rect subQueryRegion = (Rect) this.subQueryRegions.elementAt(i);
			edcEvent = new EDCGridTraverseRectNewEvent(cur, subQueryRegion,

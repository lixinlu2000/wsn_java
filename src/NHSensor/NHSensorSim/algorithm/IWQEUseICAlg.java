 ...
 */
public class IWQEUseICAlg extends IWQEAlg {
	static Logger logger = Logger.getLogger(IWQEUseICAlg.class);

	public static final String NAME = "IWQEUseIC";
	...
	public IWQEUseICAlg(Query query, Network network, Simulator simulator,

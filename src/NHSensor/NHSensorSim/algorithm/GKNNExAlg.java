...
/*
 * The difference between GKNNAlg and GKNNExAlg is whether to transmit the 
 * answers to the home node after each ring
 */
public class GKNNExAlg extends GPSRAlg {
	static Logger logger = Logger.getLogger(GKNNExAlg.class);

	public static final String NAME = "GKNNEx";
	...
	public GKNNExAlg(QueryBase query) {
		super(query);
		// TODO Auto-generated constructor stub
	}

	public GKNNExAlg(KNNQuery query, Network network, Simulator simulator,
	...
	public GKNNExAlg(KNNQuery query, Network network, Simulator simulator,
		...
		super(query, network, simulator, param, GKNNExAlg.NAME, statistics);
		// TODO Auto-generated constructor stub
	}
	...
	public boolean itenararyTraverse() throws SensornetBaseException {
		...
		lastNodeAttachmentInRing = firstNodeAttachmentInRing;
		...
		while (!this.isHasKAnswers()) {
			...
			this.forwardBackToHomeNode(lastNodeAttachmentInRing);

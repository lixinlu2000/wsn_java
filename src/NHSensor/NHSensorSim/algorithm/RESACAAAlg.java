...
import NHSensor.NHSensorSim.events.LinkAwareEDCCircleTraverseRectEventCAAForRESA;
 ...
 */
public class RESACAAAlg extends IWQEAlg {
	static Logger logger = Logger.getLogger(RESACAAAlg.class);

	public static final String NAME = "RESA_CAA";
	...
	public RESACAAAlg(Query query, Network network, Simulator simulator,
	...
	public boolean run() {
		try {
			...
			for (int subQueryRegionIndex = 0; subQueryRegionIndex < this.subQueryRegions
				...
				LinkAwareEDCCircleTraverseRectEventCAAForRESA e = new LinkAwareEDCCircleTraverseRectEventCAAForRESA(

...
import NHSensor.NHSensorSim.events.LinkAwareEDCGridTraverseRectEventCAAForRESA;
 ...
 */
public class RESACAAUseGridAlg extends IWQEAlg {
	static Logger logger = Logger.getLogger(RESACAAUseGridAlg.class);

	public static final String NAME = "RESA_CAA_UseGrid";
	...
	public RESACAAUseGridAlg(Query query, Network network, Simulator simulator,
	...
	public boolean run() {
		try {
			...
			for (int subQueryRegionIndex = 0; subQueryRegionIndex < this.subQueryRegions
				...
				LinkAwareEDCGridTraverseRectEventCAAForRESA e = new LinkAwareEDCGridTraverseRectEventCAAForRESA(

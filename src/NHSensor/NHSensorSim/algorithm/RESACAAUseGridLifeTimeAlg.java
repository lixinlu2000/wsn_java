...
import NHSensor.NHSensorSim.events.LinkAwareEDCGridTraverseRectEventCAAForRESALifeTime;
...
/*
 * RESA take advantage of grid traverse using caa
 */
public class RESACAAUseGridLifeTimeAlg extends IWQEAlg {
	static Logger logger = Logger.getLogger(RESACAAUseGridLifeTimeAlg.class);

	public static final String NAME = "RESA_CAA_UseGrid_LifeTime";
	...
	public RESACAAUseGridLifeTimeAlg(Query query, Network network, Simulator simulator,
	...
	public RESACAAUseGridLifeTimeAlg() {
		// TODO Auto-generated constructor stub
	}
	...
	public boolean run() {
		try {
			...
			for (int subQueryRegionIndex = 0; subQueryRegionIndex < this.subQueryRegions
				...
				LinkAwareEDCGridTraverseRectEventCAAForRESALifeTime e = new LinkAwareEDCGridTraverseRectEventCAAForRESALifeTime(

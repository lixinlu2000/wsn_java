...
import NHSensor.NHSensorSim.events.LinkAwareEDCCircleTraverseRectEventCDAForRESA;
...
/*
 * RESA take advantage of circle traverse
 */
public class RESAAlg extends IWQEAlg {
	static Logger logger = Logger.getLogger(RESAAlg.class);

	public static final String NAME = "RESA";
	...
	public RESAAlg(Query query, Network network, Simulator simulator,
	...
	public boolean run() {
		try {
			...
			for (int subQueryRegionIndex = 0; subQueryRegionIndex < this.subQueryRegions
				...
				LinkAwareEDCCircleTraverseRectEventCDAForRESA e = new LinkAwareEDCCircleTraverseRectEventCDAForRESA(

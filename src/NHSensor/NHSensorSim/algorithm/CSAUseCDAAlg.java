...
import NHSensor.NHSensorSim.events.EDCCircleTraverseRectEventCDA;
...
public class CSAUseCDAAlg extends IWQEAlg {
	static Logger logger = Logger.getLogger(CSAUseCDAAlg.class);

	public static final String NAME = "CSAUseCDA";
	private Vector rects = new Vector();

	public CSAUseCDAAlg(Query query, Network network, Simulator simulator,
	...
	public CSAUseCDAAlg(Query query, Network network, Simulator simulator,
		...
		super(query, network, simulator, param, CSAUseCDAAlg.NAME, statistics);
		// TODO Auto-generated constructor stub
	}
	...
	public boolean gridTraverse() throws SensornetBaseException {
		...
		EDCCircleTraverseRectEventCDA edcEvent;
		...
		for (int i = 0; i < this.subQueryRegionNum; i++) {
			...
			edcEvent = new EDCCircleTraverseRectEventCDA(cur, subQueryRegion,

...
public class GKNNUseAdaptiveGridTraverseRingEventAlg extends GPSRAlg {
	static Logger logger = Logger
			.getLogger(GKNNUseAdaptiveGridTraverseRingEventAlg.class);

	public static final String NAME = "GKNNUseAdaptiveGridTraverseRingEvent";
	...
	public GKNNUseAdaptiveGridTraverseRingEventAlg(QueryBase query) {
		super(query);
		// TODO Auto-generated constructor stub
	}

	public GKNNUseAdaptiveGridTraverseRingEventAlg(KNNQuery query,
			Network network, Simulator simulator, Param param, String name,
	...
	public GKNNUseAdaptiveGridTraverseRingEventAlg(KNNQuery query,
			Network network, Simulator simulator, Param param,
			Statistics statistics) {
		super(query, network, simulator, param,
				GKNNUseAdaptiveGridTraverseRingEventAlg.NAME, statistics);
		// TODO Auto-generated constructor stub
	}

	public GKNNUseAdaptiveGridTraverseRingEventAlg() {
		// TODO Auto-generated constructor stub
	}
	...
	protected NeighborAttachment traverseRing(
		...
		AdaptiveGridTraverseRingEvent gtre = new AdaptiveGridTraverseRingEvent(
				firstNodeAttachmentInRing, ring, this.getQueryMessage(), this);

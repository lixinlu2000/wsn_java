...
public class ESAUseGBAFailureAwareAlg extends IWQEAlg {
	static Logger logger = Logger.getLogger(ESAUseGBAFailureAwareAlg.class);

	public static final String NAME = "ESAUseGBAFailureAware";
	private Vector rects = new Vector();

	public ESAUseGBAFailureAwareAlg(Query query, Network network,
	...
	public ESAUseGBAFailureAwareAlg(Query query, Network network,
		...
		super(query, network, simulator, param, ESAUseGBAFailureAwareAlg.NAME,
				statistics);
	}

	public ESAUseGBAFailureAwareAlg() {
	}

...
import NHSensor.NHSensorSim.events.IdealItineraryTraverseRectEventFailureAware;
...
/*
 * for esa success rate experiment
 */
public class IWQEIdealUseICFailureAwareForSuccessRateAlg extends IWQEAlg {
	static Logger logger = Logger
			.getLogger(IWQEIdealUseICFailureAwareForSuccessRateAlg.class);

	public static final String NAME = "IWQEIdealUseICFailureAwareForSuccessRate";
	...
	public IWQEIdealUseICFailureAwareForSuccessRateAlg(Query query,
	...
	public IWQEIdealUseICFailureAwareForSuccessRateAlg() {
		// TODO Auto-generated constructor stub
	}
	...
	public boolean run() {
		try {
			...
			for (int subQueryRegionIndex = 0; subQueryRegionIndex < this.subQueryRegions
				...
				IdealItineraryTraverseRectEventFailureAware e = new IdealItineraryTraverseRectEventFailureAware(

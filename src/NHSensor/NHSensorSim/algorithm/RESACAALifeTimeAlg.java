...
import NHSensor.NHSensorSim.events.LinkAwareEDCCircleTraverseRectEventCAAForRESALifeTime;
...
/*
 * RESA take advantage of circle traverse using caa
 */
public class RESACAALifeTimeAlg extends IWQEAlg {
	static Logger logger = Logger.getLogger(RESACAALifeTimeAlg.class);

	public static final String NAME = "RESA_CAA_LifeTime";
	...
	public RESACAALifeTimeAlg(Query query, Network network, Simulator simulator,
	...
	public boolean run() {
		try {
			...
			for (int subQueryRegionIndex = 0; subQueryRegionIndex < this.subQueryRegions
				...
				LinkAwareEDCCircleTraverseRectEventCAAForRESALifeTime e = new LinkAwareEDCCircleTraverseRectEventCAAForRESALifeTime(

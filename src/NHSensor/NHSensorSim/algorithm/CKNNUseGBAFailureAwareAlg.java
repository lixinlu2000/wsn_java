...
public class CKNNUseGBAFailureAwareAlg extends GPSRAlg {
	static Logger logger = Logger.getLogger(CKNNUseGBAFailureAwareAlg.class);

	public static final String NAME = "CKNNUseGBAFailureAware";
	...
	public CKNNUseGBAFailureAwareAlg(QueryBase query) {
		super(query);
		// TODO Auto-generated constructor stub
	}

	public CKNNUseGBAFailureAwareAlg(KNNQuery query, Network network,
	...
	public CKNNUseGBAFailureAwareAlg(KNNQuery query, Network network,
		...
		super(query, network, simulator, param, CKNNUseGBAFailureAwareAlg.NAME,
				statistics);
		// TODO Auto-generated constructor stub
	}

	public CKNNUseGBAFailureAwareAlg() {
		// TODO Auto-generated constructor stub
	}
	...
	protected NeighborAttachment traverseRing(
		...
		DrawShapeEvent dse = new DrawShapeEvent(this, ring);
